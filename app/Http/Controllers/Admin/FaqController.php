...
class FaqController extends Controller
{
    ...
    {
        $datalist = Faq::all();
        return view('admin.faq_admin',['datalist'=> $datalist]);
    }
    ...
    {
        return view('admin.faq_admin_add');
    }
    ...
    {
        $data = Faq::find($id);
        return view('admin.faq_admin_edit',['data'=> $data]);
    }
    ...
    public function destroy(Faq $faq, $id)
    {
        ...
        return redirect()->route('admin_faq')->with('success', 'Record deleted successfully.');
    }
}
