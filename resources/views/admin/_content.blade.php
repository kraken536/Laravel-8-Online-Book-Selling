    ...
    <div class="col-12 grid-margin">
        <div class="card">
            ...
            <table class="table">
                ...
                <tr>
                    <td>
                    <img src="{{ asset('assets') }}/admin/assets/images/faces/face1.jpg" class="mr-2" alt="image"> David Grey
                    </td>
                ...
                <tr>
                    <td>
                    <img src="{{ asset('assets') }}/admin/assets/images/faces/face2.jpg" class="mr-2" alt="image"> Stella Johnson
                    </td>
                ...
                <tr>
                    <td>
                    <img src="{{ asset('assets') }}/admin/assets/images/faces/face3.jpg" class="mr-2" alt="image"> Marina Michel
                    </td>
                ...
                <tr>
                    <td>
                    <img src="{{ asset('assets') }}/admin/assets/images/faces/face4.jpg" class="mr-2" alt="image"> John Doe
                    </td>
    ...
    <div class="col-md-5 grid-margin stretch-card">
        ...
        <div class="card-body">
            ...
            <ul class="d-flex flex-column-reverse todo-list todo-list-custom">
                ...
                <i class="remove mdi mdi-closet-circle-outline"></i>
                </li>
                <li class="completed">
                <div class="form-check">
                    <label class="form-check-label">
